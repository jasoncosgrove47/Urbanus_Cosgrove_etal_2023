...
library(destiny)
library(enrichR)
source("figure5_helper_methods.R")
...
exp2.454 <- Read10X(data.dir= "Fig5_inputs/exp2/454/") 
exp2.534 <- Read10X(data.dir= "Fig5_inputs/exp2/534/") 

#18 month timepoint, we have 2 mice that were processed on different days
exp4 <- Read10X(data.dir= "Fig5_inputs/exp4/") 
exp5 <- Read10X(data.dir= "Fig5_inputs/exp5/") 

#new 6 month timepoints
exp6.m1 <- Read10X(data.dir= "Fig5_inputs/exp6/count_M85/") 
exp6.m2 <- Read10X(data.dir= "Fig5_inputs/exp6/count_M88/") 
...
load('fig5_inputs/Fig5_sobj.Rda')
...
load("Fig5_inputs/Dahlin.Rda") #dahlin dataset
