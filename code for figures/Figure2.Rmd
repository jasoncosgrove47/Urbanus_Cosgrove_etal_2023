...
setwd("/Users/jasoncosgrove/Dropbox (Team_Perie)/Jason/Experiments/Dry_Lab/JCB6_VDJMouse/Expt1_leila/Publication")
library(Seurat)
library(scran)
...
source("/Users/jasoncosgrove/Dropbox (Team_Perie)/BCM paper/resubmission nature com/Jason/code/Figure2_helpermethods.R")
...
tiff("/Users/jasoncosgrove/Desktop/clustree.tif", res = 300,width = 7, height = 9, units = "in")
...
tiff("/Users/jasoncosgrove/Desktop/clusters.tif", res = 300,width = 7, height = 7, units = "in")
DimPlot(object = lsks, label = F,reduction = "umap", pt.size = 2) 
dev.off()
...
write.csv(cluster.markers, file = "/Users/jasoncosgrove/Desktop/ClusterMarkers.csv")
...
tiff("/Users/jasoncosgrove/Desktop/umap.tif", res = 300,width = 4, height = 4, units = "in")
...
tiff("/users/jasoncosgrove/Desktop/Barplot.tiff", res = 300,width = 4, height = 5, units = 'in')
par(lwd=3)
